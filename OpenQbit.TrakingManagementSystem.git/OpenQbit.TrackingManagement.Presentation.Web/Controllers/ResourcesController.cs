...
namespace OpenQbit.TrackingManagement.Presentation.Web.Controllers
{
    public class ResourcesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ResourceID,UserID,GPSLocation")] Resource resource)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ResourceID,UserID,GPSLocation")] Resource resource)
        {
            if (ModelState.IsValid)
            {
